...
- **开箱即用的角色** — 内置 Product Owner / Tech Lead / QA / 数据分析专家 / 办公助手 / 渗透测试专家等智能体，选定即用；数据分析专家对齐项目指标口径取数（业务库 + 本地文件），覆盖异动归因、例行报告与图表看板；办公助手把知识与对话内容变成 PPT / Excel / Word / 网页演示；渗透测试专家在授权范围内做白盒渗透测试并输出 PTES 结构报告
