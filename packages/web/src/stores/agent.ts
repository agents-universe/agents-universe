...
export const useAgentStore = defineStore('agent', () => {
  ...
  async function addModelConfig(body: { provider: string; model_id: string; api_key?: string; base_url?: string; url_mode?: string; complexity_tier?: 'low' | 'mid' | 'high' | null; context_window?: number | null; thinking_enabled?: boolean | null; reasoning_effort?: 'minimal' | 'low' | 'medium' | 'high' | null }) {
  ...
  async function updateModelConfig(configId: string, body: { model_id?: string; api_key?: string; base_url?: string; url_mode?: string; complexity_tier?: 'low' | 'mid' | 'high' | null; context_window?: number | null; thinking_enabled?: boolean | null; reasoning_effort?: 'minimal' | 'low' | 'medium' | 'high' | null }) {
